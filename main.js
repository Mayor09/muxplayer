...
var audio, playbtn, title,poster, artists,mutebtn, seekslider, 
	...
	dir = "music/";
    playlist = ["ebukachris","Elektronomia","Johnning","Popsicle","Fearless"];
    title = ["Ebuka Chris","Elektronomia","Janji-Heroes Tonight","Popsicle","Lost Sky-Fearless"];
    poster = ["images/ncs1.jpeg","images/ncs2.jpg","images/ncs3.jpg","images/ncs4.jpg","images/ncs5.jpg"];
    artists = ["(feat. myself) [NCS Release]","Elektronomia-Sky High [NCS Release]","(feat. Johnning) [NCS Release]","LFZ - [NCS Release]","(feat. Chris Linton) [NCS Release]"];
    playlist_index = 0;
